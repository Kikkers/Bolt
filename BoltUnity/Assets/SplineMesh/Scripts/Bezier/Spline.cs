...
namespace SplineMesh
{
	...
	public class Spline : MonoBehaviour
	{
		...
		/// </summary>
		[SerializeField] private List<SplineNode> nodes = new List<SplineNode>();

		/// <summary>
		/// The generated curves. Should not be changed in any way, use nodes instead.
		/// </summary>
		[HideInInspector] [SerializeField] private List<CubicBezierCurve> curves = new List<CubicBezierCurve>();

		public IReadOnlyList<SplineNode> Nodes => nodes;
		public IReadOnlyList<CubicBezierCurve> Curves => curves;
		public int IndexOf(SplineNode node) => nodes.IndexOf(node);
